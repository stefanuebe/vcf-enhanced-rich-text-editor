/**
 * @see https://github.com/T-vK/DynamicQuillTools
 */
/** @class Abstract class representing a tool for a Quill Editor toolbar. */
class QuillToolbarItem {
    constructor(quill, styleContainer, options) {
        const me = this
        me.quill = quill;
        me.styleContainer = styleContainer;
        me.options = options
    ...
    _addCssRule(cssRule) {
        ...
        this.styleContainer.appendChild(style);
        // this.styleContainer.appendChild(style);
...
export class QuillToolbarDropDown extends QuillToolbarItem {
     ...
     */
    constructor(quill, styleContainer,options) {
        super(quill, styleContainer,options)
        const me = this
